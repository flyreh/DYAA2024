...
public class mainPanelOptions extends JPanelRound {
    ...
    public void initComponents(){
        ...
        information.setFont(new Font("Arial", Font.BOLD, 18));
        ...
        ImageIcon originalIcon = new ImageIcon("src/dev/two/project/utilities/media/img/cliente.png");
        ...
        iniciarPacientes.setFont(new Font("Arial", Font.BOLD, 20));
        ...
        ImageIcon originalIconDoctor = new ImageIcon("src/dev/two/project/utilities/media/img/doctoroption.png");
        ...
        iniciarDoctores.setFont(new Font("Arial", Font.BOLD, 20));
        ...
        ImageIcon originalIconRegDoctor = new ImageIcon("src/dev/two/project/utilities/media/img/agregar-doctor.png");
        ...
        registrarDoctor.setFont(new Font("Arial", Font.BOLD, 20));
        ...
        ImageIcon originalIconRegPaciente = new ImageIcon("src/dev/two/project/utilities/media/img/agregar-usuario.png");
        ...
        registrarPaciente.setFont(new Font("Arial", Font.BOLD, 20));
